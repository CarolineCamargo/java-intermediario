...
public class Aula93DataJava8 {
	...
	public static void main(String[] args) {
		...
		System.out.println(LocalDate.parse("2022-02-20").isLeapYear());
		...
		System.out.println(LocalDateTime.of(2022, 1, 1, 20, 25, 10));
		System.out.println(LocalDateTime.parse("2022-01-01T20:25:10"));
		...
		ZonedDateTime zdt = ZonedDateTime.of(LocalDateTime.parse("2022-02-20T20:25:10"), sp);
		System.out.println(zdt);
		System.out.println(ZonedDateTime.parse("2022-02-20T20:25:10-02:00[America/Sao_Paulo]"));
